...
import AnswerProblem from '../../container/answer.problem/answer.problem'
import LookProblem from '../../container/look.problem/look.problem'
import UserMyself from '../../container/user.myself/user.myself'
        ...
        return (
            <div>
                <Switch>
                    ...
                    <Redirect to='/get-doctor' component={GetDoctor}/>
                </Switch>
